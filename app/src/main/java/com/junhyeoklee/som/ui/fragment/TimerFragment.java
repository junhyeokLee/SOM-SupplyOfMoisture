...
import com.junhyeoklee.som.ui.view.ProgressTextView;
...
public class TimerFragment extends AlarmBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_alarm_timer, container, false);
            ...
            public void run() {
                if (isRunning) {
                    if (timer.isSet()) {
                        ...
                        time.setText(AlarmFormatUtils.formatMillis(remainingMillis));
