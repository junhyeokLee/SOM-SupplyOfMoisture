...
public class AlarmSoundsAdapter extends RecyclerView.Adapter<AlarmSoundsAdapter.ViewHolder> {
    ...
    public AlarmSoundsAdapter(Alarmio alarmio, List<SoundData> sounds) {
