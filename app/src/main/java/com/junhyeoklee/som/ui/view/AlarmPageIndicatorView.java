...
public class AlarmPageIndicatorView extends View implements ViewPager.OnPageChangeListener {
    ...
    public AlarmPageIndicatorView(Context context) {
        this(context, null);
    }

    public AlarmPageIndicatorView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AlarmPageIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private static class IndicatorEngine {
        ...
        private AlarmPageIndicatorView indicator;
        ...
        public void onInitEngine(AlarmPageIndicatorView indicator, Context context) {
        ...
        public void updateTextColors(AlarmPageIndicatorView indicator) {
            selectedPaint.setColor(indicator.textColorPrimary);
            unselectedPaint.setColor(indicator.textColorSecondary);
        }
