...
public enum AlarmPreferenceData {
    ...
    AlarmPreferenceData(Object value) {
        name = name();
        defaultValue = value;
    }

    AlarmPreferenceData(String name, Object value) {
        this.name = name;
        defaultValue = value;
    }
    ...
    public static class TypeMismatchException extends RuntimeException {
        ...
        public TypeMismatchException(AlarmPreferenceData data) {
            this(data, null);
        }

        public TypeMismatchException(AlarmPreferenceData data, Class expectedType) {
